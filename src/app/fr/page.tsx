...
<div className="ctp-mocha relative h-screen bg-ctp-mantle">
                ...
                <div className="flex top-10 left-0 w-screen h-screen z-10 text-ctp-text 3xl:top-0">
                    <webview src='./changelogs' className='px-[8px] 3xl:px-0 w-full h-full pt-[44px] pb-[8px] 3xl:p-0' id='loader'></webview>
                </div> 
            </div>
    </main>
  );
